room_speed = 60
draw_texture_flush()
global.chl_to_unlock = "11:0"
global.chl_to_succeed = "10:5"
with(Gamerule_1)
{
...
/*2*/TurnsToSpawnLevelBased = true //Does the variable turntospawn consist of the level variable?
	...
	TurnsToSpawn = 3; //After how many turns will a coal spawn? This changes every level if it is level based.
