room_speed = 60
draw_texture_flush()
global.chl_to_unlock = "8:2"
global.chl_to_succeed = "8:1"
with(Gamerule_1)
{
...
BombCounterDefault = 13 //The value to give to the newly spawned bomb
...
DoomCounterDefault = 13 //The value to give to the newly spawned Doom
