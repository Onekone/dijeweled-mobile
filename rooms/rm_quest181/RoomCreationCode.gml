room_speed = 60
draw_texture_flush()
global.chl_to_unlock = "18:2"
global.chl_to_succeed = "18:1"
with(Gamerule_1)
{
...
/*2*/TurnsToSpawnLevelBased = false //Does the variable turntospawn consist of the level variable?
	...
	TurnsToSpawn = 10; //After how many turns will a coal spawn? This changes every level if it is level based.
	TurnsToSpawnCur = TurnsToSpawn //This gets decreased every turn. after going to 0, it becomes TurnsToSpawn again.
LockMax = 8 //Max amount of coals on screen
}
