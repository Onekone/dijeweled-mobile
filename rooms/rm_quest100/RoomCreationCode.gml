room_speed = 60
draw_texture_flush()
global.chl_to_unlock = "10:1"
global.chl_to_succeed = "10:0"
with(Gamerule_1)
{
...
/*2*/TurnsToSpawnLevelBased = true //Does the variable turntospawn consist of the level variable?
	...
	TurnsToSpawnDefault = 7
	TurnsToSpawn = 7; //After how many turns will a coal spawn? This changes every level if it is level based.
