room_speed = 60
draw_texture_flush()
global.chl_to_unlock = "19:0"
global.chl_to_succeed = "18:5"
with(Gamerule_1)
{
...
/*2*/TurnsToSpawnLevelBased = false //Does the variable turntospawn consist of the level variable?
	TurnsToSpawnDefault = 8
	TurnsToSpawn = 8; //After how many turns will a coal spawn? This changes every level if it is level based.
