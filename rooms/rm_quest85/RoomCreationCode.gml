room_speed = 60
draw_texture_flush()
global.chl_to_unlock = "9:0"
global.chl_to_succeed = "8:5"
with(Gamerule_1)
{
...
BombCounterDefault = 8 //The value to give to the newly spawned bomb
...
DoomCounterDefault = 8 //The value to give to the newly spawned Doom
