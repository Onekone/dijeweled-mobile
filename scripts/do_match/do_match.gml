...
if Gamerule_1.illegals_allowed with(obj_avalanchedeposit) ammoving = true
...
{
	if !Gamerule_1.illegals_allowed with(obj_avalanchedeposit) ammoving = true //hypercube bug fix, count my turn
	...
	{
		if !Gamerule_1.isReplay create_dualhype_newspawn()
...
if !Gamerule_1.isReplay && Gamerule_1.replay_allowed
{
	with(Gamerule_1)
	{
		...
		{
			ds_map_delete(Gamerule_1.Replay_map, "background_nextlevel")
