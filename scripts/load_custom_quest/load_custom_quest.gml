ini_open(string(global.challenge_index)+".ini")
	#region GENERAL
		var s = "General"
		...
		if challengeallowed instance_create(64+32,1024,obj_bonus_challenge)
		var xplierallowed = ini_read_real(s,"xplierallowed",0) //NOT DONE
		if xplierallowed {instance_create(64+32,608-16,obj_xplier); instance_create(128+32,544-16,obj_xplier_num)}
			...
			#region TYPE FINDING
				switch type
				{
					case 0:
						...
						{
							instance_create(Board_1.x +8*64 -16 - 16, Board_1.y + 64*2, obj_button_undo)
							instance_create(Board_1.x +8*64 -16 -16, Board_1.y + 64*4, obj_button_reset)
						}
						break;
					case 1:
					...
					case 37:
						...
						break;
					case 42:
						obj_quest_control.L_noslightning = true
						break;
					case 43:
					...
					case 45:
						...
						break;
					case 46:
						obj_quest_control.L_nospecialgems = true
						break;
				}
			#endregion
		}
